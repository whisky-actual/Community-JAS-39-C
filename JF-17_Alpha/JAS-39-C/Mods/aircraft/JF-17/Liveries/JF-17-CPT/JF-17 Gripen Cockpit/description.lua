livery = {
	...
	{"HUD_Edge", 14, "jf17_cpt_glass_hud_color", false};
	{"HUD", 14, "jf17_cpt_glass_hud_color", false};
	{"HUD_Edge", ROUGHNESS_METALLIC, "jf17_cpt_glass_hud_roughmet", false};
	{"HUD", ROUGHNESS_METALLIC, "jf17_cpt_glass_hud_roughmet", false};
	...
	{"Pit_Frame_03", DIFFUSE, "jf17_cpt_frame_03", false};
	{"Plate_Side", DIFFUSE, "jf17_cpt_sp_plate", false};
	
	
	{"MFCD_Screen_C", DIFFUSE, "jf17_cpt_mfcd_glow", false};
	{"MFCD_Screen_L", DIFFUSE, "jf17_cpt_mfcd_glow", false};
	{"MFCD_Screen_R", DIFFUSE, "jf17_cpt_mfcd_glow", false};
}
