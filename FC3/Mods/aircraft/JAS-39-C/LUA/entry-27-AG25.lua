...
make_flyable('VSN_JAS39Gripen',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 3}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
dofile(current_mod_path.."/LUA/Views_SU27Pit.lua")
make_view_settings('VSN_JAS39Gripen_AG', ViewSettings, SnapViews)
make_flyable('VSN_JAS39Gripen_AG',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 54}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
