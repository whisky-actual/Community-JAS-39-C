...
-------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    --Flight Control
    {down = iCommandPlaneTrimOn, up = iCommandPlaneTrimOff, name = _('T/O Trim'), category = _('Flight Control')},--DONT KNOW IF THIS WORKS
    -- Systems
    ...
    {action = FCSpitch,                             name = _('F-22 FCS Pitch Axis')},
    --Core
