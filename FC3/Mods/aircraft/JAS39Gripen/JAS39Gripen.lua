...
SFM_Data = {
        aerodynamics = { -- Cx = Cx_0 + Cy^2*B2 +Cy^4*B4
            ...
            table_data = {
                ...
                [12] = { 1.300, 0.025, 0.096, 0.427, 0.17, 1.979, 13.750, 0.912 },
                [13] = { 1.500, 0.024, 0.090, 0.452, 0.20, 1.609, 10.000, 0.740 },
                [14] = { 1.700, 0.023, 0.093, 0.432, 0.30, 1.469, 10.000, 0.800 },
                [15] = { 1.850, 0.022, 0.092, 0.432, 0.38, 1.401, 10.000, 0.700 },
                [16] = { 2.000, 0.020, 0.090, 0.400, 3.20, 1.269, 10.000, 0.600 },
				[17] =	{2.2,	0.022,	0.039,	0.222,	2.5,	0.78,	10.2,	0.52},
				[18] =	{2.4,	0.025,	0.034,	0.227,	3.2,	0.7,	9,	0.4},
				[19] =	{2.5,	0.036,	0.033,	0.25,	4.5,	0.7,	9,	0.4},
				[20] =	{3.9,	0.040,	0.033,	0.35,	6,	0.7,	9,	0.4},
            }, -- end of table_data
            -- M    - Mach number
        ...
        engine = {
            ...
            --            M     Pmax     Pfor
                ...
                [17] =  { 1.50, 30362, 109733 },
                [18] =  { 1.60, 28579, 105436 },
                [19] =  { 1.70, 26791, 103436 },
                [20] =  { 1.85, 25003, 101436 },
                [21] =  { 1.90, 23220,  97117 },
                [22] =  { 3.50, 19649,  61279 },
            }, -- end of table_data
            -- M    - Mach number
