...
function update()
    ...
    set_aircraft_draw_argument_value(35,SPOILER_STATE) -- right spoiler draw angle	--Gripen arg
    set_aircraft_draw_argument_value(35,SPOILER_STATE) -- left spoiler draw angle	--Gripen arg
