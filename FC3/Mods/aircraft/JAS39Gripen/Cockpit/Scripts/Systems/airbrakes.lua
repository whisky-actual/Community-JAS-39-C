...
local speedbrake_max_effective_knots = 1440
local speedbrake_blowback_knots = 1490
local a4_max_speed_knots = 1540 -- approx, only used to calc linear speedbrake closing, and irrelevant past blowback speed anyway
