--Livery credit: Whisky Actual / MangoTango
name = "SwAF-6002-DigiCam"
countries = {}

livery = {
--MAIN MATERIALS DIFFUSE
	{"JAS39_mat1",	DIFFUSE			,	"06_jas39_mat1", true};
	{"JAS39_mat2",	DIFFUSE			,	"06_jas39_mat2", true};
	{"JAS39_mat3",	DIFFUSE			,	"06_jas39_mat3", true};
