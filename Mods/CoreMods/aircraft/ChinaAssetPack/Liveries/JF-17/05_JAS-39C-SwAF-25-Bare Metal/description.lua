...
name = "SwAF-25-Bare Metal"
countries = {}

livery = {
--MAIN MATERIALS DIFFUSE
	{"JAS39_mat1",	DIFFUSE			,	"05_jas39_mat1", true};
	{"JAS39_mat2",	DIFFUSE			,	"05_jas39_mat2", true};
	{"JAS39_mat3",	DIFFUSE			,	"05_jas39_mat3", true};
...
--MAIN MATERIALS ROUGHNESS_METALLIC
	{"JAS39_mat1",    ROUGHNESS_METALLIC            ,    "05_JAS39_Mat1_RoughMet", true};
	{"JAS39_mat2",    ROUGHNESS_METALLIC            ,    "05_JAS39_Mat2_RoughMet", true};
	{"JAS39_mat3",    ROUGHNESS_METALLIC            ,    "05_JAS39_Mat3_RoughMet", true};
--LIGTHS
