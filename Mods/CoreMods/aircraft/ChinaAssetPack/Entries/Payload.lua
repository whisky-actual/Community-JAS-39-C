...
dofile(current_mod_path .. '/Entries/Loadouts/jas39_aim-120c5.lua')
dofile(current_mod_path .. '/Entries/Loadouts/jas39_sdb.lua')
dofile(current_mod_path .. '/Entries/Loadouts/jas39_mar-1.lua')
--dofile(current_mod_path .. '/Entries/Loadouts/jas39_brimstone.lua')
