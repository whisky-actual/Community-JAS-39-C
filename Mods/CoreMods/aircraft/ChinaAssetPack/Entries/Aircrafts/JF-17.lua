...
JF_17 = {
    ...
    -------------------------
    M_empty						=	3880,	-- kg  with pilot and nose load, JAS 39C
	M_nominal					=	5430,	-- kg (Empty Plus Full Internal F)
    M_max						=	14000,	-- kg (Maximum Take Off Weight)
	M_fuel_max					=	2325,	-- kg (Internal Fuel Only)
	H_max						=	16000,	-- m  (Maximum Operational Ceiling)
	average_fuel_consumption	=	0.010,
    CAS_min                    = 58,        --
    V_opt                      = 220,       --
    ...
    thrust_sum_max            = 130000,
    thrust_sum_ab             = 220000,
   ...
   engines_nozzles = 
    ...
    Guns = {
        ...
        {
            muzzle_pos_connector   = "Gun-point",
    ...
    Pylons = {
        ...
        pylon(1, 0, -1.056, -0.125, -4.40,
            ...
            {
                 { CLSID = "DIS_PL-5EII", arg_value = 0.14, }, -- IRIS-T
                 { CLSID =  "DIS_PL-12", attach_point_position = {0.1, 0.0, 0.0}, arg_value = 0.53, }, -- AIM-9X	
        ...
        pylon(2, 0, -0.300, -0.336, -2.85,
            ...
            {
                { CLSID = "DIS_SD-10", attach_point_position = {0.4, -0.12, 0.0}, arg_value = 0.22 }, -- Meteor
                { CLSID = "DIS_PL-12", arg_value = 0.2 },
                { CLSID = "DIS_SD-10_DUAL_L", arg_value = 0 },
                { CLSID = "DIS_SD-10_DUAL_R", arg_value = 0 },
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.20, -0.14, 0.0}, arg_value = 0.14 },  -- IRIS-T



              { CLSID = "DIS_GBU_10", arg_value = 0.2 },
              { CLSID = "DIS_GBU_16", arg_value = 0.2 },
              { CLSID = "DIS_GBU_12_DUAL_GDJ_II19_L", arg_value = 0.3 },
              { CLSID = "DIS_LS_6_100_DUAL_L", arg_value = 0.3, Type = 1 },
              
             -- { CLSID = "DIS_GBU_16_DUAL_GDJ_II19_R", arg_value = 0.3 }, --2 x Gbu 16

              { CLSID = "DIS_C-701IR", arg_value = 0.1 },
              { CLSID = "DIS_C-802AK", arg_value = 0.84, Type = 1, attach_point_position ={ 0.0, -0.27, 0.0} }, -- RBS-15F Mk4 Gungnir
              { CLSID = 'DIS_CM-802AKG', arg_value = 0.9, Type = 1 },
             
              { CLSID = "DIS_LD-10_DUAL_L", attach_point_position = {0.0, 0.01, 0.0},  Type = 1}, -- SPEAR-3
              { CLSID ='DIS_LD-10', arg_value = 0 },
              { CLSID = "DIS_GB6", arg_value = 0.4, Type = 1 },
              { CLSID = "DIS_GB6_TSP", arg_value = 0.4, Type = 1 },
              { CLSID = "DIS_GB6_HE", arg_value = 0.4, Type = 1 },
        ...
        pylon(4, 0, 0.286, -0.886, 0.00,
            {
                use_full_connector_position = false, connector = "Pylon7", arg = 311, arg_value = 0
            },
            {
             
              { CLSID = "DIS_WMD7", arg_value = 0.2 },
        ...
        pylon(5, 0, 0.000, -0.450, 1.70,
            {
                use_full_connector_position = true, connector = "Pylon9", arg = 312, arg_value = 0
            },
            {
                { CLSID = "DIS_SD-10", attach_point_position = {0.4, -0.12, 0.0}, arg_value = 0.22 }, -- Meteor
                { CLSID = "DIS_PL-12", arg_value = 0.2 },
        ...
        pylon(6, 0, -0.300, -0.336, 2.85,
            {
                use_full_connector_position = true, connector = "Pylon10", arg = 313, arg_value = 0
            },
            {
                { CLSID = "DIS_SD-10", attach_point_position = {0.4, -0.12, 0.0}, arg_value = 0.22 }, -- Meteors
                { CLSID = "DIS_PL-12", arg_value = 0.2 },
                { CLSID = "DIS_SD-10_DUAL_L", arg_value = 0 },
                { CLSID = "DIS_SD-10_DUAL_R", arg_value = 0 },
                { CLSID = "DIS_PL-5EII", attach_point_position = {0.20, -0.14, 0.0}, arg_value = 0.14 },  -- IRIS-T
        ...
        pylon(7, 0, -1.056, -0.125, 4.40,
            {
                use_full_connector_position = true, connector = "Pylon11", arg = 314, arg_value = 0
            },
            {
                 { CLSID = "DIS_PL-5EII", arg_value = 0.14,  }, -- IRIS-T
                 { CLSID =  "DIS_PL-12", attach_point_position = {0.1, 0.0, 0.0}, arg_value = 0.53,  }, -- AIM-9X	
    ...
    pylon(8, 0, 0.286, -0.886, 0.00,-- 0.286, -0.886, 0.00, JEFF -- -0.765, -0.765, 0 10A 
           {
                DisplayName = "Cosmetic" , use_full_connector_position = false, connector = "Pylon6"
            },
            {
