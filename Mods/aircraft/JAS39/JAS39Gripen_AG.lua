...
--	=================== GUIDED BOMBS ==============================================================================
	...
	{ CLSID = "{JAS39_SDB}", attach_point_position = {-0.65, -0.12, 0.0}, arg_value = 0.75, Type = 1}, -- GBU-39 SDB TV Guided		
    { CLSID = "{JAS39_GBU12}", arg_value = 0.72 }, -- GBU-12 laser guided
    { CLSID = "{JAS39_BRU33_GBU12}", arg_value = 0.72, Type = 1}, -- GBU-12 laser guided x 2
	{ CLSID = "{JAS39_BRU33_GBU38}", arg_value = 0.76, Type = 1}, -- GBU-38 laser guided x 2
    { CLSID = "{JAS39_BRU33_GBU49}", arg_value = 0.80, Type = 1}, -- GBU-49 laser guided x 2	
	{ CLSID = "{JAS39_GBU16}", arg_value = 0.73 }, -- GBU-16 laser guided
	{ CLSID = "{JAS39_DWS39_TV}", arg_value = 0.82, Type =1}, -- DWS39 MJ2 TV Guided
	{ CLSID = "{JAS39_DWS39_ARM}", arg_value = 0.83, Type =1}, -- DWS39 MJ2 Anti-radiation Guided			
...
--	=================== GUIDED BOMBS ==============================================================================
	...
	{ CLSID = "{JAS39_GBU31_BLU109}", arg_value = 0.79}, -- GBU-31 Penetrator TV Guided		
	{ CLSID = "{JAS39_GBU32}", arg_value = 0.77}, -- GBU-32 TV Guided
	{ CLSID = "{JAS39_GBU38}", arg_value = 0.76}, -- GBU-38 TV Guided
	{ CLSID = "{JAS39_SDB}", attach_point_position = {-0.65, -0.12, 0.0}, arg_value = 0.75, Type = 1}, -- GBU-39 SDB TV Guided	
    { CLSID = "{JAS39_GBU12}", arg_value = 0.72 }, -- GBU-12 laser guided
...
--	=================== AIR LAUNCHED CRUISE MISSILES ==============================================================	
    { CLSID = "{JAS39_STORMSHADOW_ARM}", attach_point_position = {-0.60, 0.0, 0.0}, arg_value = 0.85, Type = 1 }, -- Storm Shadow Anti-radiation Guided
	{ CLSID = "{JAS39_KEPD350_ARM}", attach_point_position = {-0.60, 0.0, 0.0}, arg_value = 0.94, Type = 1 }, -- KEPD 350 Anti-radiation Guided		
}
...
JAS39Gripen_AG =  {
		...
		Name 			= 'JAS39Gripen_AG',
		DisplayName		= _('JAS 39 Gripen A/G'),
        Picture 		= "JAS39Gripen.png",
        Rate 			= "50",
        Shape			= "JAS39Gripen_AG",
