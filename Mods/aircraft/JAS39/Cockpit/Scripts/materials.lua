...
local LMFD_IND_PATH        = LockOn_Options.script_path .. "../Textures/Indication Textures/"  
-------TEXTURES-------
textures = {}
textures["FUEL_IND"] 	 = {LMFD_IND_PATH.."jas39-fuel-indicator.dds", materials["DBG_BLACK"]}
...
fontdescription["font_HUD"] = {
	...
	fonts["MFD_font_base"]			= {fontdescription["font_HUD"], 10, materials["DBG_WHITE"] }
	fonts["MFD_font_base_green"]			= {fontdescription["font_HUD"], 10, materials["DBG_GREEN"] }
