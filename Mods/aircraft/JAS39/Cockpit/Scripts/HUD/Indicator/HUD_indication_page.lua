...
local Alfa_indicator         = add_text_hud_param(-0.63, 0.255, "AoA","HUDBrightness", "%0.0f", Left_Side_Indication_base, HUD_strdefs_digit, "Gripen_Font_green")

local alfa_text                 =  add_text_hud("@", -0.71, 0.255, Left_Side_Indication_base , "Gripen_Font_green", HUD_strdefs_text, "CenterCenter")

local G_indicator                 = add_text_hud_param(-0.63, 0.18, "CUR_G","HUDBrightness", "%0.1f", Left_Side_Indication_base, HUD_strdefs_digit, "Gripen_Font_green")

--local G_indicatoryaw                 = add_text_hud_param(-0.53, 0.18, "Curr_Nylua","HUDBrightness", "%0.1f", Left_Side_Indication_base, HUD_strdefs_digit, "Gripen_Font_green")

local G_text                         = add_text_hud("G", -0.71, 0.18, Left_Side_Indication_base , "Gripen_Font_green", HUD_strdefs_text, "CenterCenter")

local KIAS_indicator         = add_text_hud_param(-0.70, -0.1, "txtCAS","HUDBrightness", "%0.0f", Left_Side_Indication_base, HUD_strdefs_digit, "Gripen_Font_green")

--local tester         = add_text_hud_param(0, -0.1, "DEBUGPARAM","HUDBrightness", "%0.6f", Left_Side_Indication_base, HUD_strdefs_digit, "Gripen_Font_green")
...
HorizonLineRight.element_params                 = {"HUDBrightness"}
...
HorizonLineRightRight.element_params                 = {"HUDBrightness"}
...
HorizonLineLeft.element_params                         = {"HUDBrightness"}
...
HorizonLineLeftLeft.element_params                 = {"HUDBrightness"}
...
local Alfa_readout         = add_text_hud_param(0, 0, "AoA","HUDBrightness", "%0.0f", VelocityVectorLimited, HUD_strdefs_digit, "Gripen_Font_green")
...
VelocityVectorLimitedLine.element_params                 = {"HUDBrightness"}
...
VelocityVectorHUD_Line.element_params        = {"HUDBrightness","CURRENT_PHASE_PAL"}
...
VelocityVectorAOA_Line.element_params        = {"HUDBrightness","CURRENT_PHASE_PAL", "AoA"}
...
X_AxisSymbol_Line.element_params                 = {"HUDBrightness","TO_SPEED","TO_OVERSPEED"}
...
X_AxisSymbol_Combat.element_params                = {"HUDBrightness","CURRENT_PHASE_CO"}
...
X_AxisSymbol_CombatLine.element_params                = {"HUDBrightness","CURRENT_PHASE_CO"}
