...
ud_scale      = (0.00001 * 0.9 * RS) / 10   -- 0.00001
...
for ia = 1, 900 do
	...
	radar_contact.controllers     = {
		...
		{"parameter_in_range",                          2, 30,            530000},
...
radar_cursor_range.element_params  = {"TDC_rng"}
...
radar_cursor_upper_alt.element_params = {"TDCElUpper"}
...
radar_cursor_lower_alt.element_params = {"TDCElLower"}
