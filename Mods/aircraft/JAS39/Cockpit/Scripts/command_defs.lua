...
SHC = {
	StepTarget = __custom_counter(),

	RadarSearchModeHatUpVerticalSearch = __custom_counter(),
	RadarSearchModeHatDownNormalSearch = __custom_counter(),
	RadarSearchModeHatLeftWideSearch = __custom_counter(),
	RadarSearchModeHatRightHUDHMDSearch = __custom_counter(),

	SHC3UpRadarAntennaElevationUp = __custom_counter(),
	SHC3DownRadarAntennaElevationDown = __custom_counter(),

	SHC4ForwardAirbrakeIn = __custom_counter(),
	SHC4BackAirbrakeOut = __custom_counter(),

	SHC5LockSwitchH0 = __custom_counter(),
	SHC5LockSwitchH1 = __custom_counter(),
	SHC5LockSwitchH2 = __custom_counter(),

	SHC6CycleRadarScale = __custom_counter(),

	-- SHC7RadarSend = __custom_counter(),

	SHC8CycleRadarSearchVolume = __custom_counter(),

	-- SHC9SHCRelease = __custom_counter(),

	SHC10ForwardCDScaleDown = __custom_counter(),
	SHC10BackCDScaleUp      = __custom_counter(),

	SHC11ContinuousTracking = __custom_counter(),

	SHC12AutoThrottleToggle = __custom_counter(),

	SHC13PointPrio = __custom_counter()
}
