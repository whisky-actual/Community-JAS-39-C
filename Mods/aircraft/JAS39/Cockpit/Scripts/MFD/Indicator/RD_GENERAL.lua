...
GRAY_Background.material		= materials["MFDGray"]
...
StaticRD.element_params		= {"ONE"}
StaticRD.controllers		= {{"change_color_when_parameter_equal_to_number", 0, 1, 1, 1, 1}} -- Idk why this is needed.
AddElement(StaticRD)
