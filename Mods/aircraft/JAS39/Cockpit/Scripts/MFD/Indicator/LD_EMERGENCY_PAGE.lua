...
Light_Black_Background.element_params 	= {"LD_BRIGHTNESS"}
...
ADI_EMGY_BACKGROUND.element_params  = {"LD_BRIGHTNESS","ADI_ATTITUDE"}
...
ADI_EMGY_FRAME.element_params   = {"LD_BRIGHTNESS"}
...
ADI_EMGY_ATTITUDE.element_params    = {"LD_BRIGHTNESS"}
...
ADI_EMGY_ROLL_MARKER.element_params 	= {"LD_BRIGHTNESS","ADI_ROLL",}
...
rpm_indicator.element_params 	= {"LD_BRIGHTNESS","LD_ENG_TOGGLE"}
...
rpm_needle.element_params 	= {"LD_BRIGHTNESS", "RPM_NEEDLE"}
...
tgt_indicator.element_params 	= {"LD_BRIGHTNESS","LD_ENG_TOGGLE"}
...
tgt_needle.element_params 	= {"LD_BRIGHTNESS", "TGT_NEEDLE",}
...
Mach_indicator.element_params 		= {"LD_BRIGHTNESS","machWhole"}
...
Mach_indicator2.element_params 		= {"LD_BRIGHTNESS","machWhole"}
...
ALFA_SYMBOL_EMGY.element_params  = {"LD_BRIGHTNESS"}
...
FuelSquare.element_params   = {"LD_BRIGHTNESS"}
...
AIRSPEED_EMGY_SCALE.element_params  = {"LD_BRIGHTNESS"}
...
AIRSPEED_EMGY_ARROW.element_params  = {"LD_BRIGHTNESS","EMGY_IAS"}
...
HEADING_TAPE_EMGY.element_params  	= { "LD_BRIGHTNESS","EMGY_HEADING"}
...
ALTITUDE_SCALE_EMGY.element_params  	= { "LD_BRIGHTNESS","EMGY_ALTITUDE"}
...
ALTITUDE_SCALE_EMGY2.element_params  	= { "LD_BRIGHTNESS","EMGY_ALTITUDE"}
...
ALTITUDE_SCALE_EMGY3.element_params  	= { "LD_BRIGHTNESS","EMGY_ALTITUDE"}
...
ALTITUDE_SCALE_EMGY4.element_params  	= { "LD_BRIGHTNESS","EMGY_ALTITUDE"}
...
ALTITUDE_EMGY_ARROW.element_params  = {"LD_BRIGHTNESS"}
...
VSI_SCALE_EMGY.element_params  = {"LD_BRIGHTNESS", "LD_VSI_TOGGLE"}
...
VSI_SCALE_EMGY_ARROW.element_params  = {"LD_BRIGHTNESS", "EMGY_VS", "LD_VSI_TOGGLE"}
...
DISPLAY_TEMP_EMGY.element_params  = {"LD_BRIGHTNESS", "LD_TEMP_TOGGLE"}
