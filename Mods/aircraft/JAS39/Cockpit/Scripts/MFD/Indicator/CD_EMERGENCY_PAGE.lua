...
Light_Black_Background.element_params 	= {"CD_BRIGHTNESS"}
...
ADI_EMGY_FRAME.element_params   = {"CD_BRIGHTNESS"}
...
ADI_EMGY_ATTITUDE.element_params    = {"CD_BRIGHTNESS"}
...
ADI_EMGY_ROLL_MARKER.element_params 	= {"CD_BRIGHTNESS","ADI_ROLL",}
...
rpm_indicator.parent_element 	= CD_EMGY_PAGE.name
rpm_indicator.element_params 	= {"CD_BRIGHTNESS","CD_ENG_TOGGLE"}
...
rpm_needle.element_params 	= {"CD_BRIGHTNESS", "RPM_NEEDLE"}
...
local Digital_rpm = white_text_param_with_CD_brightness(0.16, -0.19, "RPM_PARAM_U", "%02.0f", rpm_indicator, mfd_strdefs_digit, "Gripen_Font_WHITE", "LeftCenter")

local Digital_rpm_100 = add_text_with_CD_brightness("1", 0.12, -0.19, rpm_indicator , "Gripen_Font_WHITE", mfd_strdefs_digit, "LeftCenter")
...
tgt_indicator.parent_element 	= CD_EMGY_PAGE.name
tgt_indicator.element_params 	= {"CD_BRIGHTNESS","CD_ENG_TOGGLE"}
...
tgt_needle.element_params 	= {"CD_BRIGHTNESS", "TGT_NEEDLE",}
...
local Digital_TGT = white_text_param_with_CD_brightness(0.09, -0.2, "TGT_PARAM", "%02.0f", tgt_indicator, mfd_strdefs_digit, "Gripen_Font_WHITE", "LeftCenter")
...
Mach_indicator.element_params 		= {"CD_BRIGHTNESS","MACH_B"}
...
Mach_indicator2.element_params 		= {"CD_BRIGHTNESS","MACH_A"}
...
white_text_param_with_CD_brightness(-0.5, 0.7, "CUR_AOA", "%0.0f", CD_EMGY_PAGE, mfd_strdefs_digit, "Gripen_Font_WHITE")
...
ALFA_SYMBOL_EMGY.element_params  = {"CD_BRIGHTNESS"}
...
FuelSquare.element_params   = {"CD_BRIGHTNESS"}
...
AIRSPEED_EMGY_SCALE.element_params  = {"CD_BRIGHTNESS"}
...
AIRSPEED_EMGY_ARROW.element_params  = {"CD_BRIGHTNESS","EMGY_IAS"}
...
AIRSPEED_EMGY_READOUT = white_text_param_with_CD_brightness(-0.15,0.0 , "CURR_IAS", "%0.0f", AIRSPEED_EMGY_ARROW, mfd_strdefs_digit, "Gripen_Font_WHITE") 
...
HEADING_ARROW_EMGY.element_params   = {"CD_BRIGHTNESS"}
...
ALTITUDE_EMGY_ARROW.element_params  = {"CD_BRIGHTNESS"}
...
VSI_SCALE_EMGY.element_params  = {"CD_BRIGHTNESS", "CD_VSI_TOGGLE"}
...
VSI_SCALE_EMGY_ARROW.element_params  = {"CD_BRIGHTNESS", "EMGY_VS", "CD_VSI_TOGGLE"}
...
DISPLAY_TEMP_EMGY.element_params  = {"CD_BRIGHTNESS", "CD_TEMP_TOGGLE"}
