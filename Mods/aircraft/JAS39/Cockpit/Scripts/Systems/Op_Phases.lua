...
current_phase_STATIONARY:set(0)
current_phase_PARKED:set(0)
current_phase_TAXI:set(0)
current_phase_TGR:set(0)
current_phase_ROT:set(0)
current_phase_LO:set(0)
current_phase_CO:set(0)
current_phase_PAL:set(0)
current_phase_TD:set(0)
landingMode:set(0)
...
function update()
	...
	if (rpm < 60) and (self_gs <= 27) and (wow_n == 1) and (wow_l == 1) and (gear_n_up == 0) and (wow_r == 1) then -- nytt				
		currentPhase:set(1)
		current_phase_STATIONARY:set(1)
	...
	if (self_gs > 27) and (self_gs <= 39) and (wow_n == 1) and (wow_l == 1) and (gear_n_up == 0) and (wow_r == 1) then
		currentPhase:set(3)
		current_phase_TAXI:set(1)
		landingMode:set(0) -- Disable landing mode after touch down
	...
	if (self_gs > 39) and (wow_n == 1) and (wow_l == 1) and (wow_r == 1) and (gear_n_up == 0) and (get_param_handle("landingMode"):get() == 1) then
		currentPhase:set(10)
		current_phase_LR:set(1)
		debug_print("Current operational phase: LR")
	else
		current_phase_LR:set(0)
	end
end
