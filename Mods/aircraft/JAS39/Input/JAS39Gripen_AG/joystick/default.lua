...
-- Gripen Weapons
{down = Keys.TriggerAG,	     		up = Keys.TriggerAG,       	name = _('Trigger'),									category = _('Gripen Weapons'), 			value_down =  1.0,		value_up = 0.0},
...
--{down = GearToggle,   						name = _('Gripen Landing Gear - Toggle'), 	               	category = _('Systems')},
--{down = GearUp,   							name = _('Gripen Landing Gear - Up'), 	               		category = _('Systems')},
--{down = GearDown,   						name = _('Gripen Landing Gear - Down'), 	              	category = _('Systems')},
...
{action = iCommandPlaneSelecterHorizontalAbs, name = _('LDP Slew Horizontal')},
{action = iCommandPlaneSelecterVerticalAbs	, name = _('LDP Slew Vertical')},
{action = iCommandPlaneMFDZoomAbs 			, name = _('LDP Zoom')},
