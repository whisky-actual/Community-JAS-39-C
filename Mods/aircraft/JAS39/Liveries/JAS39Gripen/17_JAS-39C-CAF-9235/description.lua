--Livery credit: 313_Paegas
name = "CAF 9235"
countries = {}

livery = {
--MAIN MATERIALS DIFFUSE
	{"JAS39_mat1",	DIFFUSE			,	"17_jas39_mat1", true};
	{"JAS39_mat2",	DIFFUSE			,	"17_jas39_mat2", true};
...
--PILOT
	...
	{"JAS39_pilothelmet",	DIFFUSE			,	"JAS39_PilotHelmet_Tiger_White", true};
...
--ENGINES
	...
	{"JAS39_engines",	ROUGHNESS_METALLIC			,	"jas39_engines_dark_RoughMet", true};
-- OTHERS
	...
	{"JAS39_drop_tank_1100", DIFFUSE   ,  "JAS39_Drop_Tanks_Orange_Diff", true};
	...
	{"JAS39_drop_tank_1700", DIFFUSE , "JAS39_Drop_Tanks_Orange_Diff", true};	
