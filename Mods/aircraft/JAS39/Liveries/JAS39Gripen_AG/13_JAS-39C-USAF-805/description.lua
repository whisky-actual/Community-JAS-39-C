--Livery credit: Whisky Actual and Roughmaster
name = "USAF-805"
countries = {}

livery = {
--MAIN MATERIALS DIFFUSE
	{"JAS39_mat1",	DIFFUSE			,	"13_jas39_mat1", true};
	{"JAS39_mat2",	DIFFUSE			,	"13_jas39_mat2", true};
	{"JAS39_mat3",	DIFFUSE			,	"13_jas39_mat3", true};
