...
local jas_spear3_model = 'jas39_spear-3'

JAS_SPEAR3_MISSILE =
{
	category        = CAT_MISSILES,
    name            = jas_spear3_name,
    user_name       = _(jas_spear3_name),
    model           = jas_spear3_model,
	...
	warhead = jas_spear3_warhead,
	warhead_air = jas_spear3_warhead,
	
}

declare_weapon(JAS_SPEAR3_MISSILE)

declare_loadout({
    category        = CAT_MISSILES,
    CLSID           = "{JAS39_SPEAR3}",
    wsTypeOfWeapon  = JAS_SPEAR3_MISSILE.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 3,
    Cx_pil          = 0.0001,
    Picture         = "jas39_spear-3.png",
    displayName     = _('3 x ' .. jas_spear3_name),
    Weight          = jas_spear3_mass * 3 + 90,
	ejectImpulse    = 140,	
	Elements = {
