local jas_aim9l_name = 'AIM-9L Sidewinder IR AAM'
local jas_aim9l_mass = 85
local pylon_mass = 1.0

JAS_AIM9L_AA = {
    category        = CAT_AIR_TO_AIR,
    name            = jas_aim9l_name,
    user_name       = _(jas_aim9l_name),
...
declare_weapon(JAS_AIM9L_AA)
JAS_AIM9L_AA.shape_table_data.index = JAS_AIM9L_AA.wsTypeOfWeapon[4]
...
declare_loadout({
    ...
    displayName 	= _(jas_aim9l_name),
    Cx_pil      	= 0.0001,
    Count       	= 1,
    Weight      	= jas_aim9l_mass + pylon_mass,
    Elements    	= {
		[1]	=
		{
			Position	=	{0, 0, 0},
