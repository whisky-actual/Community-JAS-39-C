...
local jas_agm_65h_name = "jas_agm_65h"
local jas_agm_65h_mass = 208
local pylon_mass = 52.0

JAS_AGM_65_H =
{
    category        = CAT_MISSILES,
    name            = jas_agm_65h_name,
    user_name       = _("AGM-65H TV Guided Missile"),
    class_name      = "wAmmunitionSelfHoming",
    model           = "agm-65h",
    mass            = jas_agm_65h_mass,
...
declare_loadout({
	...
	wsTypeOfWeapon	= JAS_AGM_65_H.wsTypeOfWeapon,
    displayName 	= JAS_AGM_65_H.user_name,
    Cx_pil      	= 0.0001,
    Count       	= 1,
    Weight      	= jas_agm_65h_mass + pylon_mass,
    Elements    	= {
		[1]	=
		{
			Position	=	{0, 0, 0},
