local jas_gbu_38 =
{
	...
	name			= "jas_gbu-38",
	model			= "gbu-38",
	user_name		= _("GBU-38 500 lb TV Guided Glide-Bomb"),
	scheme			= "bomb_jdam",
...
declare_loadout({
	...
	wsTypeOfWeapon	= jas_gbu_38.wsTypeOfWeapon,
	attribute		= {4, 4, 32, WSTYPE_PLACEHOLDER},
	Count 			= 2,
	Cx_pil			= jas_gbu_38.Cx,
	Picture			= "gbu38.png",
	displayName		= _('2 x ' .. jas_gbu_38.user_name),
	Weight			= (jas_gbu_38.mass * 2) + 75,
	Elements = { {
			IsAdapter = true,
			ShapeName = "BRU_33A"
		}, {
