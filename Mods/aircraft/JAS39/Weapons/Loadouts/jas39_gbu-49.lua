...
local jas_gbu_49 =
{
	...
	name			= "jas_gbu-49",
	model			= "gbu-12",
	user_name		= _("GBU-49 500lb TV Guided Bomb"),
	scheme			= "bomb_jdam",
	class_name		= "wAmmunitionChangeableTrajectory",
	
	warhead = simple_warhead(180.0),
	warhead_air = simple_warhead(180.0),
...
declare_weapon(jas_gbu_49)

declare_loadout({
	category 		= CAT_BOMBS,
	CLSID	 		= "JAS39_GBU49",
	attribute		= jas_gbu_49.wsTypeOfWeapon,
	Count 			= 1,
	Cx_pil			= jas_gbu_49.Cx,
	Picture			= "gbu12.png",
	displayName		= jas_gbu_49.user_name,
	Weight			= jas_gbu_49.mass,
