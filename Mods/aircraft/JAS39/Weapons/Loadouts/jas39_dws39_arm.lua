...
local jas_dws39_arm_name = "jas_dws39_arm"
local jas_dws39_arm_mass = 620
local pylon_mass = 52.0

JAS_DWS_39_ARM =
{
    category        = CAT_MISSILES,
    name            = jas_dws39_arm_name,
    user_name       = _("DWS 39 MJ2 Anti-radiation Cluster Bomb"),
    scheme          = "AGM-154AB",
    class_name      = "wAmmunitionCruise",
    model           = "bk_90",
    mass            = jas_dws39_arm_mass,
    ...
    fm = {
        ...
        L                   = 4.5,
        I                   = 1 / 12 * jas_dws39_arm_mass * 4.5 * 4.5,
        Ma                  = 2,
        Mw                  = 7,
        wind_sigma          = 0.0,
        wind_time           = 0.0,
...
declare_weapon(JAS_DWS_39_ARM)

declare_loadout({
    category        = CAT_MISSILES,
    CLSID           = '{JAS39_DWS39_ARM}',
    attribute       = JAS_DWS_39_ARM.wsTypeOfWeapon,
    Count           = 1,
    Cx_pil          = 0.0024,
    Picture         = "jas39_dws39.png",
    displayName     = JAS_DWS_39_ARM.user_name,
    Weight          = JAS_DWS_39_ARM.mass + pylon_mass,
